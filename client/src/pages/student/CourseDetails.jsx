        ...
        <>
            <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
                ...
                <div className='max-w-xl z-1 text-gray-600'>
                    ...
                    <p className='text-sm'>Course by <span className='text-[#1269e2] underline'>Promise Digitals</span></p>
                ...
                <div className='max-w-[424px] z-1 custom-shadow rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
                    ...
                    <div className='p-5'>
                        ...
                        <button className='md:mt-6 mt-4 w-full py-3 rounded bg-[#1269e2] text-white font-medium'>{isAlreadyEnrolled ? 'Already Enrolled' : 'Enroll Now'}</button>
