...
const TestimonialSection = () => {
    return (
        <div className='pb-14 px-8 md:px-0'>
            ...
            <p className='md:text-base text-gray-500 mt-3'>Hear are our learners as they share journeys of transformation, success and how our <br /> platform has made a difference in their lives.</p>
